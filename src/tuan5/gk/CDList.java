...
public class CDList {
	...
	public boolean xoaCD(int maCD) {
		int viTri = timViTriTheoMa(maCD);
			if (viTri == -1) {
				System.out.println("Ko tim thay CD ma:" + maCD);
				return false;
			}
 ...
 // Sắp xếp tăng dần theo tựa
	...
	public void hienthiDanhSach() {
		...
		System.out.println("\n+------------+-----------------------+-------------+--------------------------------+");
		System.out.println("|	Ma CD	|		TuaCD			|Số bai hat	|		Gia Thanh  |");
		System.out.println("+-----------+-----------------------+------------------+-------------------------------+");	
		for (int i = 0; i < soLuong; i++)
